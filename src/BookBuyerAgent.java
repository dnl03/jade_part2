...
public class BookBuyerAgent extends Agent {
    ...
    private class RequestPerformer extends Behaviour {
        ...
        private long timeout = 10000; // TODO: Ustawienie czasu oczekiwania na odpowiedź - 10 sekund
        private long startTime; // TODO: Zmienna do sprawdzania startu

        public void action() {
            switch (step) {
                case 0:
                    //call for proposal (CFP) to found sellers
                    startTime = System.currentTimeMillis(); // TODO: zapisanie czasu systemu podczas wyslania zapytania
                ...
                case 1:
                    ...
                    } else if (System.currentTimeMillis() - startTime > timeout) { // TODO: Sprawdzenie czy upłynął czas oczekiwania
                        step = 2; // TODO: przejscie do kroku 2 jezeli czas minął
                    } else {
                        block();
                    }
                    break;
                case 2:
                    if (bestSeller != null) {
                        ...
                        System.out.println("No valid offers were received.");
                        step = 4; // TODO: Zakończenie jeżeli nie otrzymano zadnej oferty
                    }
                    break;
                case 3:
