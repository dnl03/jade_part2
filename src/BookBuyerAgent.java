...
public class BookBuyerAgent extends Agent {
    ...
    private int myBudget; //TODO: #1 DODANIE BUDŻETU DO BUYERA

    protected void setup() {
        myBudget = 100; //TODO: #2 Inicjalizacja budżetu startowego
        targetBookTitle = "";
        System.out.println("Hello! " + getAID().getLocalName() + " is ready for the purchase order. With Budget " + myBudget);
        ...
        public void action() {
            switch (step) {
                ...
                case 2:
                    ...
                    //TODO: #3 dodanie warunku sprawdzajacego czy mamy wystarczajacy budzet
                    if (myBudget >= bestPrice) {
                        ...
                        //TODO: #4 dodanie informacji ze budzet niest nie wystarczajacy
                        step = 4;
                        System.out.println(getAID().getLocalName() + ": Not enough budget (" + myBudget + ") to place the order (" + bestPrice + ") ");
                    }
                    break;
                case 3:
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.INFORM) {
                            //purchase succeeded
                            //TODO: #5 obliczanie budzetu po zakupie:
                            myBudget -= bestPrice;
                            System.out.println(getAID().getLocalName() + ": " + targetBookTitle + " purchased for " + bestPrice + " from " + reply.getSender().getLocalName());
                            System.out.println(getAID().getLocalName() + ": waiting for the next purchase order. Actual budget = " + myBudget);
